...
CREATE TABLE GIAYKHAMBENH (
    ...
    PRIMARY KEY(MAGIAYKHAMBENH),

    CONSTRAINT FK_GIAYKHAMBENH_HOSOBENHAN
    FOREIGN KEY(MAHSBA)
    REFERENCES HOSOBENHAN,

    CONSTRAINT FK_GIAYKHAMBENH_HOADON
...
CREATE TABLE DICHVUSUDUNG (
    ...
    PRIMARY KEY(MAGIAYKHAMBENH, MADICHVU),

    CONSTRAINT FK_DICHVUSUDUNG_GIAYKHAMBENH
    FOREIGN KEY(MAGIAYKHAMBENH)
...
CREATE TABLE TOATHUOC (
    ...
    PRIMARY KEY(MAGIAYKHAMBENH, MATHUOC),
